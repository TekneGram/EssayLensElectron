...
import type { NormalizedRubric, RubricInteractionMode } from './types';
              ...
              return (
                <th key={categoryId}>
                  <div
                    className={[
                      "rubric-axis-field",
                      "rubric-axis-field--category",
                      classNames?.axisField,
                    ]
                      .filter(Boolean)
                      .join(' ')}
                  >
                    {isEditing ? (
                      ...
                      <div className="rubric-axis-field__value rubric-axis-field__value--category">
                        {category.name}
                      </div>
                    )}
                  </div>
                    ...
                    <td key={key}>
                      {isEditing ? (
                        <textarea
                          ...
                          onChange={(event) =>
                            onSetCellDescription(categoryId, scoreId, event.target.value)
                          }
                        ...
                        <button
                          ...
                          className={[
                            ...
                            .join(' ')}
                          onClick={() =>
                            (isSelected ? onDeselectCell : onSelectCell)?.(categoryId, scoreId)
                          }
                        ...
                        <div className="rubric-table__cell-text">
                          {cell?.description ?? ''}
                        </div>
                      )}
                    </td>
